...
//     // Make the API call for side menu using Axios
//     const sideMenuResponse = await axios.post(
//         'http://localhost:8086/v1/api/admin/auth/sidebar-menus',
//         {
...
//     // Check if the side menu request was successful
//     if (sideMenuResponse.status === 200) {
//         // Process the side menu data as needed
//         console.log('Side Menu Data:', sideMenuResponse.data.sidebarMenus);
//     } else {
//         // Handle errors or display error message for side menu request
//         console.error('Error during side menu API call:', sideMenuResponse.statusText);
//     }

//     // Call the checkLogin function with the response data
//     checkLogin(response.data, navigate);
// } else {
