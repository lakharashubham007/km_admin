...
//         <Card>
//           <CardBody>
//             <h4 className="card-title">Hotel Creation Form</h4>

//             {/* Use TextInput Component */}
//             <TextInput label="Hotel Name" id="hotel-name" defaultValue="" />

//             {/* Use EmailInput Component */}
//             <EmailInput label="Hotel Email" id="hotel-email" defaultValue="" />

//             {/* Use PasswordInput Component */}
//             <PasswordInput label="Password" id="hotel-password" defaultValue="" />
